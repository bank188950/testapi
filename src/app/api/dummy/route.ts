...
export function GET(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (page === "1") {
    return Response.json(dataList.slice(0, 10));
  }

  if (page === "2") {
    return Response.json(dataList.slice(10, 20));
  }

  if (page === "3") {
    return Response.json(dataList.slice(20, 30));
  }

  if (page === "4") {
    return Response.json(dataList.slice(30, 40));
  }

  if (page === "5") {
    return Response.json(dataList.slice(40, 50));
  }

  if (page === "6") {
    return Response.json(dataList.slice(50, 60));
  }

  if (page === "7") {
    return Response.json(dataList.slice(60, 70));
  }
}
